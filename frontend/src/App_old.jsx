        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6 mb-4 relative">
          ...
          <div className="mb-5">
            ...
            <p className="text-xs text-slate-500 mt-3 text-center font-medium">
              Don't know? We've auto-detected your region
            </p>
          </div>
          ...
          <div className="flex gap-3 relative z-10">
            <button
              ...
              className="flex-1 px-6 py-4 bg-gradient-to-br from-blue-500 to-purple-600 text-white font-semibold text-base rounded-2xl hover:shadow-xl hover:shadow-blue-500/50 disabled:from-slate-300 disabled:to-slate-400 disabled:cursor-not-allowed disabled:shadow-none transition-all duration-300 active:scale-95"
            >
              {isProcessing ? (
